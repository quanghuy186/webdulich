    ...
    <body>
                ...
                <div class="row">
                   <div class="col-md-12 col-xs-12 top-5">
                      <div class="cl-logo fl">
                         <h1 class="logo">
                            <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="imgs/logo-viet-nam-travel.png" alt="logo"/></a>
                         </h1>
                      </div>
                      <div class="cl-bnt fl">
                         <div class="banner-top">
                            <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="imgs/banner-top.jpg" alt="banner top"></a>
                         </div>
                      </div>
       ...
       <div class="container-fluid">
          <div class="slider-wrapper theme-default">
             <div id="slider-master" class="nivoSlider">
                <a href="https://vietnamtravel.net.vn/vi/loai-tour/30-4/1.html"><img src="imgs/bai-dinh-trang-an.jpg" data-thumb="imgs/bai-dinh-trang-an.jpg" alt="aa" title="" /></a>
                <a href=""><img src="imgs/phu-quoc-hon-mong-tay-vietnam-travel.jpg" data-thumb="imgs/phu-quoc-hon-mong-tay-vietnam-travel.jpg" alt="aa" title="" /></a>
             </div>
          </div>
       </div>
       <script type="text/javascript" src="js/jquery.nivo.slider.js"></script>
       ...
       <div class="container box-list-tour top-30">
          <div class="row">
             <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
                ...
                <div class="w100 fl title-tour1">
                   <h2 style="color: #ffc700;font-size: 30px;"><img src="https://vietnamtravel.net.vn/assets/desktop/images/icon_mb.png" alt="icon" style="width: 80px;">Tour Quốc tế</h2>
                </div>
                <!-- <div class=" w100 fl child-lst-tour2">
                   <img src="https://vietnamtravel.net.vn/assets/desktop/images/icon-tit2.png" alt="icon">
                   </div> -->
             ...
             <div class="col-md-12 col-xs-12 bx-content-lst-tour">
                <div class="row">
                   <div class="col-md-4 col-xs-12 lst-tour-item">
                      <div class="w100 fl bx-wap-pr-item">
                         <div class="clearfix box-wap-imgpr">
                            <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/472-tour-du-lich-singapore-malaysia-4-ngay-3-dem-gia-kich-cau-sap-thi-truong-dich-vu-cao-cap-nhat-co-cam-ket.html">
                               <img src="imgs/ha-noi-kuala-lumpur-cao-nguyen-genting-ha-noi.jpg" class="img-default" alt="tour" style="margin-bottom: 6px;">
                               <img src="imgs/8-3.png" class="img-event-8-3">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                            </a>
                         </div>
                         <div class="clear"></div>
                         <h4><a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/472-tour-du-lich-singapore-malaysia-4-ngay-3-dem-gia-kich-cau-sap-thi-truong-dich-vu-cao-cap-nhat-co-cam-ket.html">Tour Du lịch Singapore Malaysia 4 ngày 3 Đêm giá kích cầu, Sập Thị trường, dịch vụ cao cấp nhất, có cam kết</a></h4>
                         <div class="clear"></div>
                         <div class="group-calendar w100 fl">
                            <div class="col-md-6 col-xs-7 date-start">
                               <i class="fa fa-calendar"></i> 
                         ...
                         <div class="group-book w100 fl">
                            ...
                            <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/472-tour-du-lich-singapore-malaysia-4-ngay-3-dem-gia-kich-cau-sap-thi-truong-dich-vu-cao-cap-nhat-co-cam-ket.html" class="link-book btn_view_tour0">Xem chi tiết</a>
                         </div>
                      </div>
                   </div>
                   <div class="col-md-4 col-xs-12 lst-tour-item">
       ...
       <div class="container box-list-tour top-30">
          <div class="row">
             <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
                <div class="w100 fl title-tour1">
                   <h2 style="color: #ffc700;font-size: 30px;"><img src="https://vietnamtravel.net.vn/assets/desktop/images/icon_mb.png" alt="icon" style="width: 80px;">Tour nội địa</h2>
                </div>
                <!--  <div class=" w100 fl child-lst-tour2">
                   <img src="https://vietnamtravel.net.vn/assets/desktop/images/icon-tit2.png" alt="icon">
                   </div> -->
             ...
             <div class="col-md-12 col-xs-12 bx-content-lst-tour">
                <div class="row">
                   <div class="col-md-4 col-xs-12 lst-tour-item">
                      <div class="w100 fl bx-wap-pr-item">
                         <div class="clearfix box-wap-imgpr">
                            <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/467-tour-doc-la-tron-goi-ha-noi-ha-giang-lung-cu-deo-ma-phi-song-nho-que-sapa-fansipan.html">
                               <img src="imgs/sapa4.png" class="img-default" alt="tour" style="margin-bottom: 6px;">
                               <img src="imgs/merry-christmas-1.png" class="img-event-giang-sinh">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                            </a>
                         </div>
                         <div class="clear"></div>
                         <h4><a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/467-tour-doc-la-tron-goi-ha-noi-ha-giang-lung-cu-deo-ma-phi-song-nho-que-sapa-fansipan.html">Tour độc lạ, trọn gói: Hà Nội - Hà Giang - Lũng Cú - Đèo Mã Phì - Sông Nho Quế - Sapa - Fansipan</a></h4>
                         <div class="clear"></div>
                         <div class="group-calendar w100 fl">
                            <div class="col-md-6 col-xs-7 date-start">
                               <i class="fa fa-calendar"></i> 
                         ...
                         <div class="note-attack"><i class="fa fa-bell" aria-hidden="true"></i> Vé thuyền trên sông Nho Quế</div>
                         <div class="group-book w100 fl">
                            <span class="price-sell">8.990.000 VNĐ </span>
                            <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/467-tour-doc-la-tron-goi-ha-noi-ha-giang-lung-cu-deo-ma-phi-song-nho-que-sapa-fansipan.html" class="link-book btn_view_tour0">Xem chi tiết</a>
                         </div>
                      </div>
                   </div>
                   <div class="col-md-4 col-xs-12 lst-tour-item">
